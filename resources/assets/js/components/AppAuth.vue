        ...
        <div class="app-auth-container">
            <div class="app-auth-intro">
                ...
                <div class="intro-boxes">
                    ...
                    <div class="intro-box">
                        ...
                        <div class="intro-text">For developers, by developers</div>
                    </div>
                    <div class="intro-box">
                        <div class="intro-icon">
            ...
            <div class="app-auth-form">
                <div class="app-auth-signin" v-if="$route.params.form == 'signin' || $route.params.form == undefined || ( $route.params.form != 'signup' && $route.params.form != 'forgot' && $route.params.form != 'reset' )">
                    <h2>Sign in</h2>
                    <form @submit.prevent="handleSignIn" @keydown="errors.signin.clear($event.target.dataset.name)">
                ...
                <div class="app-auth-signup" v-else-if="$route.params.form == 'signup'">
                    <h2>Sign up</h2>
                    <form @submit.prevent="handleSignUp" @keydown="errors.signup.clear($event.target.dataset.name)">
                        <div class="input-field">
                ...
                <div class="app-auth-signup" v-else-if="$route.params.form == 'forgot'">
                    ...
                    <form @submit.prevent="handleForgotPassword" @keydown="errors.forgot.clear($event.target.dataset.name)">
                        <div class="input-field">
                ...
                <div class="app-auth-signup" v-else-if="$route.params.form == 'reset'">
                    ...
                    <form @submit.prevent="handleResetPassword" @keydown="errors.reset.clear($event.target.dataset.name)">
                        <div class="input-field">
